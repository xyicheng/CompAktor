...
class HeartbeatMonitor(object):
    ...
    def __init__(self, actor_system, interval=30, per_actor=False,
                 actors_per_check=100):
        """
        Constructor
    ...
    async def check_running_tree(self, system_path):
        ...
        be checked sequentially to avoid computational slow down. This method
        is called at the interval supplied to the class. An alternative would
